...
export default function EditAideFaq() {
  ...
  const [name, setName] = useState("Aide & FAQ");
  const [slug, setSlug] = useState("aide-faq");
  ...
  const handleSave = () => {
    if (typeof window !== "undefined") {
      localStorage.setItem("aide-faq-content", content);
    }
    router.push("/pages/aide-faq");
  };
  return (
    <div className="max-w-3xl mx-auto p-8 bg-white rounded shadow mt-8">
      ...
      <div className="flex gap-4 justify-end">
        ...
        <button
          ...
          onClick={() => router.push("/pages/aide-faq")}
        >
          Annuler
        </button>
      </div>
